  ...
  return (
    <SafeAreaView style={{ flex:1, backgroundColor: theme.colors.bg }}>
      <View style={{ flexDirection:'row', alignItems:'center', padding:16, gap:12 }}>
        ...
        <Text style={{ fontFamily: FONTS.display.bold, fontSize: 20, color: theme.colors.textPrimary }}>PriceCalculatorScreen</Text>
      </View>
      <ScrollView contentContainerStyle={{ padding:16, paddingBottom:100 }}>
        <View style={{ backgroundColor: theme.colors.bgCard, borderRadius:20, padding:32, borderWidth:1, borderColor:theme.colors.border, alignItems:'center' }}>
          ...
          <Text style={{ fontFamily: FONTS.body.semibold, color: theme.colors.textPrimary, marginTop:16 }}>PriceCalculatorScreen Ready</Text>
