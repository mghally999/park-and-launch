...
export default function TrackCharterScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.colors.bg }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: SPACING.base, gap: SPACING.md }}>
        ...
        <Text style={{ fontFamily: FONTS.display.bold, fontSize: TYPE_SCALE.xl, color: theme.colors.textPrimary }}>TrackCharter</Text>
      </View>
